...
#include "model/FMS/fmsdevice.h"
#include <QScopedPointer>

using namespace flux_qt;

class FMSCommService : public ProcessorAbstract
{
        Q_OBJECT
    public:
        FMSCommService(const QString& processorName);
        ~FMSCommService() override;
    ...
    private:
        ...
        QScopedPointer<FMSDevice> mFMSDevice{nullptr};
